...
casper.start();
var productsList = [];
acLinks.forEach(function (acCrawler) {
    casper.thenOpen(acCrawler.url, function () {
        this.echo("----------------------------------------");
        if (acCrawler.isScroll === true) {
            this.scrollToBottom();
            casper.waitForSelectorTextChange(acCrawler.selectors.elements, function () { });
